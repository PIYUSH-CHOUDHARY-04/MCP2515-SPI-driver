...
/**
 * File: MCP2515.h
 * Description: This header file contains the declaration of IO Control and configuration
 ...
 * @retval void
 */
void CAN_Write_ID(uint8_t Frame_type, uint8_t* TXB, uint8_t* can_id);
 ...
 */
uint8_t CAN_Read_ID(uint8_t* RXB, uint8_t* can_id);
 ...
 * @retval void
 */
void CAN_Write_DLC(uint8_t* TXB, uint8_t dlc);
 ...
 * @ retval void
 */
void CAN_Read_DLC(uint8_t* RXB, uint8_t* dlc);
 ...
 * @retval void
 */
void CAN_Write_data(uint8_t* TXB, uint8_t* data, uint8_t dlc);
 ...
 */
uint8_t CAN_Read_data(uint8_t* RXB, uint8_t* data);
